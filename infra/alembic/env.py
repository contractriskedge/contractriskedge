...
Handles database connection, migration context, and async
execution for PostgreSQL with pgvector support.
"""
...
def run_migrations_offline() -> None:
    ...
    emitting SQL as a script instead of executing directly.
    """
