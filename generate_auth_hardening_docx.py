#!/usr/bin/env python3
"""Convert production-auth-hardening.md to Word .docx"""
...
title = doc.add_heading('ContractRiskEdge \u2014 Auth + Tenant Isolation + RBAC Hardening', level=0)
title.alignment = WD_ALIGN_PARAGRAPH.CENTER
sub = doc.add_paragraph('Critical Security Corrections & Operational Hardening \u2014 Pre-Implementation')
...
with open('docs/production-auth-hardening.md', 'r') as f:
    content = f.read()
...
outpath = 'docs/production-auth-hardening.docx'
doc.save(outpath)
