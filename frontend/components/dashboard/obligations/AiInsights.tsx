...
import { Brain, AlertTriangle, AlertOctagon, Clock, Lightbulb, ChevronRight, Sparkles } from "lucide-react";
import type { ObligationInsight } from "./types";
...
function InsightCard({ insight, index }: { insight: ObligationInsight; index: number }) {
