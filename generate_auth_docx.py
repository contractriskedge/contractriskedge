#!/usr/bin/env python3
"""Convert production-auth-tenant-rbac.md to Word .docx"""
...
title = doc.add_heading('ContractRiskEdge \u2014 Production Auth + Tenant Isolation + RBAC Implementation', level=0)
title.alignment = WD_ALIGN_PARAGRAPH.CENTER
sub = doc.add_paragraph('V1 Enterprise-Grade Identity, Multi-Tenant Security & Authorization')
...
with open('docs/production-auth-tenant-rbac.md', 'r') as f:
    content = f.read()
...
outpath = 'docs/production-auth-tenant-rbac.docx'
doc.save(outpath)
