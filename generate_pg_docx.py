#!/usr/bin/env python3
"""Convert production-postgresql-schema.md to Word .docx"""
...
title = doc.add_heading('ContractRiskEdge \u2014 Production PostgreSQL Schema Blueprint', level=0)
title.alignment = WD_ALIGN_PARAGRAPH.CENTER
sub = doc.add_paragraph('V1 Physical Database Design for Enterprise AI-Native Contract Intelligence')
...
with open('docs/production-postgresql-schema.md', 'r') as f:
    content = f.read()
...
outpath = 'docs/production-postgresql-schema.docx'
doc.save(outpath)
