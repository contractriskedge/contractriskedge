...
MITIGATION_EFFECTIVENESS_REGISTRY: dict[str, dict[str, dict]] = {
    ...
    "intellectual_property": {
        ...
        "clarifying_no_license": {
            "effectiveness_pct": 0.14,
            "confidence": 0.82,
            "source": "legal_precedent",
            "label": "Clarifying no license is granted",
            "description": "States that no IP license is granted except the limited purpose of the agreement",
        },
    },
    "data_privacy": {
    ...
    "data_protection": {
        "adding_dpa": {
            ...
            "confidence": 0.82,
            "source": "industry_standard",
            "label": "Adding Data Processing Agreement terms",
            "description": "Ensures compliant data processing with DPA-aligned contractual terms",
        },
        "restricting_data_use": {
            "effectiveness_pct": 0.22,
            "confidence": 0.82,
    ...
    "confidentiality": {
        "broadening_confidentiality": {
            "effectiveness_pct": 0.18,
            "confidence": 0.80,
            "source": "industry_standard",
            "label": "Broadening confidentiality obligations",
            "description": "Expands definition of confidential information and strengthens protection obligations",
        },
        "restricting_data_use": {
            "effectiveness_pct": 0.16,
            "confidence": 0.78,
            "source": "legal_precedent",
            "label": "Restricting data use and sharing",
            "description": "Limits how counterparty can use and share confidential information",
        },
        "adding_data_breach_protocol": {
            "effectiveness_pct": 0.14,
            "confidence": 0.82,
            "source": "industry_standard",
            "label": "Adding data breach notification protocol",
            "description": "Mandates timely breach disclosure for confidential information",
        },
        "adding_return_of_information": {
            "effectiveness_pct": 0.16,
            "confidence": 0.84,
            "source": "industry_standard",
            "label": "Adding return/destruction of confidential information",
            "description": "Requires prompt return or certified destruction of confidential materials upon termination",
        },
        "adding_remedies_clause": {
            "effectiveness_pct": 0.12,
            "confidence": 0.80,
            "source": "legal_precedent",
            "label": "Adding remedies and injunctive relief",
            "description": "Preserves equitable remedies for breach of confidentiality obligations",
        },
        "clarifying_exclusions": {
            "effectiveness_pct": 0.10,
            "confidence": 0.78,
            "source": "legal_precedent",
            "label": "Clarifying confidentiality exclusions",
            "description": "Defines standard exclusions from confidentiality obligations",
        },
    },
    "term_termination": {
        "extending_notice_period": {
            "effectiveness_pct": 0.10,
            "confidence": 0.78,
            "source": "legal_precedent",
            "label": "Extending notice period for termination",
            "description": "Provides longer notice period for termination without cause",
        },
        "adding_for_cause_termination": {
            "effectiveness_pct": 0.16,
            "confidence": 0.86,
        ...
        "reducing_termination_notice": {
            ...
            "source": "legal_precedent",
            "label": "Reducing termination notice period",
            "description": "Shortens notice period for faster exit",
        },
        "adding_auto_renewal_opt_out": {
            "effectiveness_pct": 0.12,
            "confidence": 0.84,
    ...
    "payment_audit": {
        "adding_audit_rights": {
            ...
            "source": "industry_standard",
            "label": "Adding audit and inspection rights",
            "description": "Provides right to verify financial compliance with contractual obligations",
        },
        "adding_price_protection": {
            "effectiveness_pct": 0.12,
            "confidence": 0.75,
    ...
    "sla_support": {
        "adding_sla_guarantees": {
            "effectiveness_pct": 0.14,
            "confidence": 0.80,
            "source": "industry_standard",
            "label": "Adding SLA guarantees and service credits",
            "description": "Defines minimum performance standards with remedy mechanisms",
        },
        "adding_service_levels": {
            "effectiveness_pct": 0.14,
            ...
            "source": "industry_standard",
            "label": "Adding service level commitments",
            "description": "Sets uptime, response time, and resolution time commitments",
        },
    },
    "assignment_change_control": {
        "adding_change_of_control": {
            "effectiveness_pct": 0.14,
            "confidence": 0.78,
            "source": "industry_standard",
            "label": "Adding change of control protections",
            "description": "Provides rights and protections when counterparty undergoes change of control",
        },
        "adding_for_cause_termination": {
            "effectiveness_pct": 0.12,
            "confidence": 0.80,
            "source": "legal_precedent",
            "label": "Adding change-of-control termination right",
            "description": "Allows termination if counterparty is acquired by a competitor",
        },
    },
    "force_majeure": {
        "clarifying_warranty_scope": {
            ...
            "confidence": 0.72,
            "source": "legal_precedent",
            "label": "Clarifying force majeure scope",
            "description": "Narrows force majeure provisions to exclude foreseeable events",
        },
        "adding_dispute_resolution": {
            "effectiveness_pct": 0.08,
            "confidence": 0.70,
            "source": "industry_standard",
            "label": "Adding force majeure dispute mechanism",
            "description": "Establishes process for resolving force majeure claims",
        },
    },
    ...
    "insurance": {
        "adding_indemnification": {
            ...
            "source": "industry_standard",
            "label": "Adding indemnification clause",
            "description": "Requires counterparty to maintain adequate insurance coverage",
        },
        "adding_liability_cap": {
            "effectiveness_pct": 0.12,
            "confidence": 0.78,
            "source": "industry_standard",
            "label": "Adding liability cap aligned with insurance",
            "description": "Sets liability limits commensurate with insurance coverage",
        },
    },
    "non_compete_exclusivity": {
        "narrowing_ip_license": {
            ...
            "confidence": 0.76,
            "source": "legal_precedent",
            "label": "Narrowing exclusivity and non-compete scope",
            "description": "Restricts scope of exclusivity and non-compete obligations",
        },
        "adding_ip_ownership_clause": {
            "effectiveness_pct": 0.14,
            "confidence": 0.80,
